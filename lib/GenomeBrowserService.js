        ...
        this.send = function (action) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_o) {
                ...
                if (action.type === action_1.OutgoingActionType.SET_FOCUS) {
                    ...
                    (_f = this.genomeBrowser) === null || _f === void 0 ? void 0 : _f.clear_switch(__spreadArray(["track"], action.payload.track_ids));
                }
                    ...
                    (_h = this.genomeBrowser) === null || _h === void 0 ? void 0 : _h.clear_switch(__spreadArray(["label"], action.payload.track_ids));
                }
                    ...
                    this.bpPerScreen = this.bpPerScreen + 10000;
                    (_k = this.genomeBrowser) === null || _k === void 0 ? void 0 : _k.set_bp_per_screen(this.bpPerScreen);
                }
                    ...
                    this.x = this.x + 10000;
                    (_m = this.genomeBrowser) === null || _m === void 0 ? void 0 : _m.set_x(this.x);
                }
                else {
