        ...
        this.send = function (action) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_k) {
                ...
                if (action.type === action_1.OutgoingActionType.SET_FOCUS) {
                    ...
                    this.bpPerScreen = this.bpPerScreen + 10000;
                    (_g = this.genomeBrowser) === null || _g === void 0 ? void 0 : _g.set_bp_per_screen(this.bpPerScreen);
                }
                else if (action.type === action_1.OutgoingActionType.MOVE_LEFT) {
                    this.x = this.x - 10000;
                    (_h = this.genomeBrowser) === null || _h === void 0 ? void 0 : _h.set_x(this.x);
                }
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 1:
                        ...
                        (_e = this.genomeBrowser) === null || _e === void 0 ? void 0 : _e.set_message_reporter(function (x) {
