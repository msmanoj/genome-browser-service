        ...
        this.send = function (action) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_q) {
                ...
                if (action.type === action_1.OutgoingActionType.SET_FOCUS) {
                    ...
                    (_d = this.genomeBrowser) === null || _d === void 0 ? void 0 : _d.set_switch(["track"]);
                    (_e = this.genomeBrowser) === null || _e === void 0 ? void 0 : _e.set_switch(__spreadArray(["track"], action.payload.track_ids));
                    (_f = this.genomeBrowser) === null || _f === void 0 ? void 0 : _f.set_switch(["label"]);
                    (_g = this.genomeBrowser) === null || _g === void 0 ? void 0 : _g.set_switch(__spreadArray(["label"], action.payload.track_ids));
                }
                else if (action.type === action_1.OutgoingActionType.TURN_OFF_TRACKS) {
                    (_h = this.genomeBrowser) === null || _h === void 0 ? void 0 : _h.clear_switch(__spreadArray(["track"], action.payload.track_ids));
                }
                else if (action.type === action_1.OutgoingActionType.TURN_ON_LABELS) {
                    (_j = this.genomeBrowser) === null || _j === void 0 ? void 0 : _j.set_switch(__spreadArray(["label"], action.payload.track_ids));
                }
                else if (action.type === action_1.OutgoingActionType.TURN_OFF_LABELS) {
                    (_k = this.genomeBrowser) === null || _k === void 0 ? void 0 : _k.clear_switch(__spreadArray(["label"], action.payload.track_ids));
                }
                else if (action.type === action_1.OutgoingActionType.ZOOM_IN) {
                    this.bpPerScreen = this.bpPerScreen - 10000;
                    (_l = this.genomeBrowser) === null || _l === void 0 ? void 0 : _l.set_bp_per_screen(this.bpPerScreen);
                }
                else if (action.type === action_1.OutgoingActionType.ZOOM_OUT) {
                    this.bpPerScreen = this.bpPerScreen + 10000;
                    (_m = this.genomeBrowser) === null || _m === void 0 ? void 0 : _m.set_bp_per_screen(this.bpPerScreen);
                }
                else if (action.type === action_1.OutgoingActionType.MOVE_LEFT) {
                    this.x = this.x - 10000;
                    (_o = this.genomeBrowser) === null || _o === void 0 ? void 0 : _o.set_x(this.x);
                }
                else if (action.type === action_1.OutgoingActionType.MOVE_RIGHT) {
                    this.x = this.x + 10000;
                    (_p = this.genomeBrowser) === null || _p === void 0 ? void 0 : _p.set_x(this.x);
                }
                else {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 1:
                        _g.sent();
                        _f = this;
                        return [4 /*yield*/, new peregrine_ensembl_js_1.GenomeBrowser()];
                    case 2:
                        _f.genomeBrowser = _g.sent();
                        return [4 /*yield*/, ((_a = this.genomeBrowser) === null || _a === void 0 ? void 0 : _a.go())];
                    case 3:
                        _g.sent();
                        return [4 /*yield*/, ((_b = this.genomeBrowser) === null || _b === void 0 ? void 0 : _b.set_stick("homo_sapiens_GCA_000001405_27:1"))];
                    case 4:
                        _g.sent();
