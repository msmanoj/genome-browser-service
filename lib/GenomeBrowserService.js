                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (action.type === action_1.OutgoingActionType.SET_FOCUS) {
                            this.genomeBrowser.set_stick((_a = action.payload) === null || _a === void 0 ? void 0 : _a.focus);
                        }
                            ...
                            this.genomeBrowser.set_switch(__spreadArray(["track"], action.payload.track_ids));
                        }
                        else if (action.type === action_1.OutgoingActionType.TURN_OFF_TRACKS) {
                            this.genomeBrowser.clear_switch(__spreadArray(["track"], action.payload.track_ids));
                        }
                        else {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this.genomeBrowser.set_bp_per_screen(1000000);
